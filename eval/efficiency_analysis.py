...
from networks.IterNet import Iternet
from networks.CTFNet import LadderNetv6
from networks.Attunet import AttU_Net
from networks.unet_pp import UNet_pp
from networks.RollingUnet import Rolling_Unet_M
...
if __name__ == '__main__':
    ...
    images_path = '/mnt/nasv3/zs/RRWNet_zs/train/_Data/RITE/test/enhanced'

    fns = sorted(Path(images_path).glob('*.png'))
    # print(fns)
    # raise ValueError
